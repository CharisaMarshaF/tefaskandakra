...
<div class="sidebar d-none d-md-flex flex-column p-4 vh-100 position-fixed top-0 start-0">
    ...
    <ul class="nav flex-column mt-2">
        <li class="nav-item mb-2">
            <a href="{{ route('siswa.dashboard') }}" class="nav-link active py-3 px-4 d-flex align-items-center fw-medium">
        ...
        <li class="nav-item mb-2">
            <a href="{{ route('siswa.projects') }}" class="nav-link py-3 px-4 d-flex align-items-center fw-medium">
                <i class="fa-solid fa-gears me-3 fs-5"></i> Produksi TEFA
            </a>
        </li>
        <li class="nav-item mb-2">
            <a href="{{ route('siswa.project_progress.index') }}" class="nav-link py-3 px-4 d-flex align-items-center fw-medium">
                <i class="fa-solid fa-chart-bar me-3 fs-5"></i> Laporan Progres
            </a>
        </li>
        <li class="nav-item mb-2">
            <a href="{{ route('siswa.nilai_project.index') }}" class="nav-link py-3 px-4 d-flex align-items-center fw-medium">
